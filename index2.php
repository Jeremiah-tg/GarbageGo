...
$toEmail = "jeremyokello12@gmail.com";
$mailHeaders = "From: " . $_POST["your_name"] . "<". $_POST["your_email"] .">\r\n";
if(mail($toEmail, $_POST["message"], $_POST["your_phone"], $mailHeaders)) {
...
//
//   $yourName = $database->real_escape_string($_POST['your_name']);
//   $yourEmail = $database->real_escape_string($_POST['your_email']);
//   $yourPhone = $database->real_escape_string($_POST['your_phone']);
//   $message = $database->real_escape_string($_POST['message']);
//
//
//   $sql = "INSERT INTO message (name, email, phone, message) values('".$yourName."','".$yourEmail."','".$yourPhone."','".$message."')";
//
//
//   if(!$result = $database->query($sql)){
//     die('There was an error sending the message ['.$database->error . ']');
//     }
//     else{
//       echo "Thank you for the message. We will get back to you.";
//     }
//   } else{
    ...
    <section id="contact" class="col-lg-8">
      ...
      <p>Have a question or need assistance? Feel free to get in touch with us.</p>
        <form action="#" method="post" class="p-5">
            ...
            <input type="number" id="contact" name="your_phone" required>

            <label for="message">Your Message</label>
            <textarea id="message" rows="9" name="comments" required></textarea>

            <button type="submit" name="submit" value="message">Send Message</button>
        </form>
    </section>
</div></center>
